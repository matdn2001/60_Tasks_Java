...
class zad66 {
    ...
    public static void ulan(int x){
        ...
        if (x == 1 || x == 2)
            System.out.println(ANSI_YELLOW + x + " число в последовательнсоти Улана равно " + x);
        else
            System.out.println(ANSI_YELLOW + x + " число в последовательнсоти Улана равно " + Ulans_numbers.get(len - 1));
    }
}
