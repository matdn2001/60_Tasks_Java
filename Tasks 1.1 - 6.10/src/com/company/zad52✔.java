...
class zad52 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(ANSI_YELLOW + canMove(x, s1, s2, f1, f2, y, z) + ANSI_RESET);
    }
    ...
    public static String canMove(String name, int s1, int s2, int f1, int f2, String y, String z) {
        ...
        if (flag)
            return ANSI_YELLOW + name + " может сделать ход из клетки " + y + " в клетку " + z + ANSI_RESET;
        else
            return ANSI_YELLOW + name + " не может сделать ход из клетки " + y + " в клетку " + z + ANSI_RESET;
    }
}