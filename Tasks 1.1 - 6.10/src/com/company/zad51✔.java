...
class zad51 {
    ...
    public static void encrypt(String s){
        ...
        System.out.println(ANSI_YELLOW + "Ваша зашифрованная строка выглядит следующим образом: " + result);
    }
    public static void decrypt(String[] array){
        ...
        System.out.println(ANSI_YELLOW + "Ваша расшифрованная строка выглядит следующим образом: " + result);
    }
}
